...
RUN ./configure --prefix=/opt/riscv --with-arch=rv32if --with-abi=ilp32f
RUN make
...
ENV PATH=$PATH:/opt/riscv/bin/ \
    C_INCLUDE_PATH=/opt/riscv/riscv32-unknown-elf/include/ \
    LD_LIBRARY_PATH=/opt/riscv/riscv32-unknown-elf/lib/ \
    CC=/opt/riscv/bin/riscv32-unknown-elf-gcc \
    CXX=/opt/riscv/bin/riscv32-unknown-elf-g++
